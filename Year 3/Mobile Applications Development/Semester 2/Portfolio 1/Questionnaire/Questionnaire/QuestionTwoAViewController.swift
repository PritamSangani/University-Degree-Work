//
//  QuestionTwoAViewController.swift
//  Questionnaire
//
...
class QuestionTwoAViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        question = Answer(questionTitle: "question_2a")
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "questionThree" {
