...
CREATE TABLE `BakerBusinessType` (
    `bakerBusinessTypeID` int(10) NOT NULL AUTO_INCREMENT,
    `businessTypeID` int(10) NOT NULL,
    `bakerID` int(10) NOT NULL,
    PRIMARY KEY(bakerBusinessTypeID),
    CONSTRAINT FK_BusinessTypeID FOREIGN KEY (businessTypeID) REFERENCES BusinessType(businessTypeID),
    CONSTRAINT FK_BakerBusinessType FOREIGN KEY (bakerID) REFERENCES baker(bakerID));
