...
namespace GlobalTradingDataApp
{
    public class BinTree<T> where T : IComparable
    {
        ...
        public BinTree(Node<T> node) => root = node;

        public void InOrder(ref string buffer) => InOrder(root, ref buffer);
        ...
        public void PreOrder(ref string buffer) => PreOrder(root, ref buffer);
        ...
        public void PostOrder(ref string buffer) => PostOrder(root, ref buffer);
